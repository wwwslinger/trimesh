...
|Github Actions| |Coverage Status| |PyPI version| |Join the chat at
...
checks (``xxhash``) and more, the easiest way to get a full ``trimesh``
...
-  `vtkplotter <https://github.com/marcomusy/vtkplotter>`__ Visualize
